...
const { buildDataQualityFieldValidityContract } = loadTsModule("src/lib/data-quality-field-validity.ts");

console.log(JSON.stringify(buildDataQualityFieldValidityContract(), null, 2));
