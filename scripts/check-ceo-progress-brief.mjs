...
if (run.status !== 0) {
  ...
  for (const phrase of [
    ...
    "Route options: mock_runtime_hardening:default_now, bounded_readonly_attempt:requires_separate_ceo_named_action",
    ...
    "Approval outcome:",
    "Next meaningful gate: separately named bounded row coverage readonly attempt or mock runtime hardening",
    "publicDataSource=mock",
    "scoreSource=mock",
    "sqlExecuted=false",
    "connectionAttempted=false",
