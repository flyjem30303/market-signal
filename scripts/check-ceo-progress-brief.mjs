...
for (const phrase of [
  ...
  "Workstream status",
  "Workstream queue",
  "snapshot.runtimeWorkstreamIntegration.workMix.pmRuntime",
  "snapshot.runtimeWorkstreamIntegration.workMix.a1Evidence",
  "snapshot.runtimeWorkstreamIntegration.workMix.a2PublicCopy",
  "snapshot.runtimeWorkstreamIntegration.workMix.iLaunchOps",
  "snapshot.runtimeWorkstreamIntegration.items.map",
  "Runtime",
  "Runtime route",
  "Remote trigger",
  "Route options",
...
if (run.status !== 0) {
  ...
  for (const phrase of [
    ...
    "Workstream mix: PM 70% / A1 20% / A2 10% / I 0%",
    "Workstream status: pm_mainline_active_parallel_inputs_pending / runtime_readiness_integration",
    "Workstream queue: pm_runtime_mainline:active_mainline, a1_evidence_handoff:parallel_input_pending, a2_public_copy_gate:ready_when_report_passes, i_launch_operations_guard:guard_only",
    "Runtime: 50% / readying",
    ...
    "A1 intake: accepted_for_mainline_review / local_prerequisites_defined_remote_evidence_missing",
    "A1 verification: 1:a1-promotion-prerequisites, 2:mainline-intake-protocol, 3:aggregate-review-gate, 4:production-build, 5:dev-recovery-after-build, 6:localhost-health-after-recovery",
