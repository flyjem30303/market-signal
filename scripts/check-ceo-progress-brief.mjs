...
if (run.status !== 0) {
  ...
  for (const phrase of [
    ...
    "Workstream mix: PM 70% / A1 20% / A2 10%",
    "Workstream status: pm_mainline_active_parallel_inputs_pending / runtime_readiness_integration",
    "Workstream queue: pm_runtime_mainline:active_mainline, a1_evidence_handoff:parallel_input_pending, a2_public_copy_gate:ready_when_report_passes",
    "Runtime: 50% / readying",
