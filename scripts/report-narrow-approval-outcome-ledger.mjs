...
const { getNarrowApprovalOutcomeLedger } = loadTsModule("src/lib/narrow-approval-outcome-ledger.ts");

console.log(JSON.stringify(getNarrowApprovalOutcomeLedger(), null, 2));
