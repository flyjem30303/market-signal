...
const reportPath = "docs/reviews/CP3_MOCK_ONLY_RUNTIME_IMPLEMENTATION_STOP_GATE_2026-05-30.md";
const report = fs.readFileSync(reportPath, "utf8");

const requiredPhrases = [
  "Status: CP3 mock-only runtime implementation stop gate recorded",
  "STOP_BEFORE_RUNTIME_IMPLEMENTATION",
  "ready to ask for a future planning-to-execution approval",
  "does\nnot approve runtime implementation",
  "does not edit app runtime files",
  ...
  "does not import state names into public UI",
  "does\nnot read runtime state packets",
...
const forbiddenPhrases = [
  ...
  "state names are imported into public UI",
