...
const reportPath = "docs/reviews/CP3_TWSE_STOCK_DAY_STAGING_READ_ONLY_VALIDATOR_DRAFT_REVIEW_2026-05-29.md";

const requiredPhrases = [
  "Status: read-only validator draft recorded",
  "REVISE",
  "CEO does not approve running the validator against Supabase yet",
  "draft review only",
