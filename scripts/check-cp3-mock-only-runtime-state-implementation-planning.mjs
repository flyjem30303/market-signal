...
const reportPath = "docs/reviews/CP3_MOCK_ONLY_RUNTIME_STATE_IMPLEMENTATION_PLANNING_2026-05-30.md";
const report = fs.readFileSync(reportPath, "utf8");

const requiredPhrases = [
  "Status: CP3 mock-only runtime state implementation planning recorded",
  "PROCEED_TO_PLANNING_ONLY",
  "plans a future mock-only runtime state implementation slice\nwithout implementing runtime behavior",
