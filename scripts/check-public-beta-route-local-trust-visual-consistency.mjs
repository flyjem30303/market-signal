...
const routes = [
  ...
  { path: "/methodology", required: ["方法說明", "資料品質", "正式市場資料尚未啟用"] },
...
const registration = [
  ...
  },
  {
    file: reviewGatePath,
    pass:
      reviewGate.includes("scripts/check-public-beta-route-local-trust-visual-consistency.mjs") &&
      reviewGate.includes('"public-beta-route-local-trust-visual-consistency"')
  }
];
