...
const required = [
  ...
  [helperPath, "allowedAction"],
  [helperPath, "blockedAction"],
  [helperPath, "nextGate"],
  [helperPath, "owner"],
  ...
  [helperPath, "Runtime UX hardening"],
  [helperPath, "Readonly evidence interpretation"],
  [helperPath, "Data quality acceptance"],
  [helperPath, "CEO named bounded readonly attempt"],
  ...
  [homePath, "status.owner"],
  [homePath, "status.allowedAction"],
  [homePath, "status.blockedAction"],
  [homePath, "status.nextGate"],
  ...
  [stockPath, "status.owner"],
  [stockPath, "status.allowedAction"],
  [stockPath, "status.blockedAction"],
  [stockPath, "status.nextGate"],
  ...
  [briefingPath, "status.owner"],
  [briefingPath, "status.allowedAction"],
  [briefingPath, "status.blockedAction"],
  [briefingPath, "status.nextGate"],
