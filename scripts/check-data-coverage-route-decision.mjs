...
const required = [
  ...
  [libPath, "observedRows: 182"],
  [libPath, "missingRows: 178"],
  [libPath, "prepare_twii_coverage_repair_gate"],
  [libPath, "twii-coverage-repair-gate"],
  [libPath, "etf-source-rights-gate"],
