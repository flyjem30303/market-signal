...
if (snapshot.status !== 0) {
  ...
  if (output.project?.lanes?.find((lane) => lane.label === "Data freshness and quality evidence")?.current !== 88) {
    blocked.push("Data freshness and quality evidence lane expected 88");
  }
