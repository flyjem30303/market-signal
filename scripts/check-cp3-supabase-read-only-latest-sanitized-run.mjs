...
const target = "docs/reviews/CP3_SUPABASE_READ_ONLY_LATEST_SANITIZED_RUN_2026-06-03.md";
...
const requiredPhrases = [
  ...
  "ACCEPT_READ_ONLY_OBJECT_REACHABILITY_AS_BACKEND_EVIDENCE_ONLY",
  ...
  "Supabase object reachability is now verified",
  "resolves the previous object-reachability blocker",
