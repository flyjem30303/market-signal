...
const reportPath = "docs/reviews/CP3_SUPABASE_READ_ONLY_REMOTE_RUN_APPROVAL_GATE_DRAFT_2026-05-30.md";
...
const requiredPhrases = [
  ...
  "conditional approval for the project to prepare a bounded Supabase\nread-only remote validation path",
  "does not execute the command",
  "does\nnot connect to Supabase",
  "does not change the current fail-closed validator\ncode",
  ...
  "It intentionally approves only the path, not the\nremote run.",
  "The next safe slice is a remote-capable validator implementation\ngate draft",
...
const forbiddenPhrases = [
  ...
  "Supabase connection is authorized now",
