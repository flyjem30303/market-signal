...
const checks = [
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-a1-a2-handoff-packet.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-a1-a2-handoff-packet"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-pm-handoff-receiver-router.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-pm-handoff-receiver-router"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-a1-a2-outcome-intake-ledger.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-a1-a2-outcome-intake-ledger"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-a1-a2-outcome-dry-run-recorder.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-accepted-outcome-aggregation-gate.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-accepted-outcome-aggregation-gate"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-authorization-route-selector.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-authorization-route-selector"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-outcome-evidence-scavenger.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-outcome-evidence-scavenger"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-single-authorization-packet-review-only.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-server-preexecution-readiness-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-operator-credential-presence-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-operator-credential-presence-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-server-only-presence-recheck-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-server-only-presence-recheck-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-operator-owned-presence-confirmation-path-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-external-presence-reviewed-result-shape-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-presence-reviewed-result-shape-no-execution"
  },
  {
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-write-gate-dry-run-preview-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-write-gate-dry-run-preview-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-write-gate-fail-closed-simulation-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-local-lane-plan-pack-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-local-lane-plan-pack-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-local-lane-checklist-runner-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-local-lane-checklist-runner-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-evidence-checklist-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-evidence-checklist-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-evidence-runner-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-evidence-runner-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-evidence-intake-format-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-evidence-intake-format-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-evidence-intake-validator-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-evidence-intake-validator-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-evidence-acceptance-ledger-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-completed-evidence-validator-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-completed-evidence-validator-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-ledger-sync-candidate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-ledger-sync-candidate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-ledger-sync-apply-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-ledger-sync-apply-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-external-platform-ledger-append-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-data-online-external-platform-ledger-append-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-data-online-readonly-gate-preflight-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-data-online-bounded-readonly-runner-stub-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-aggregate-readonly-result-to-write-gate-or-env-repair.mjs"],
    expectStatus: "ok",
    name: "phase-1-aggregate-readonly-result-to-write-gate-or-env-repair"
  },
  {
    command: [node, "scripts/check-phase-1-server-only-credential-presence-reviewed-result.mjs"],
    expectStatus: "ok",
    name: "phase-1-server-only-credential-presence-reviewed-result"
  },
  {
    command: [node, "scripts/check-phase-1-external-operator-presence-reviewed-result.mjs"],
    expectStatus: "ok",
    name: "phase-1-external-operator-presence-reviewed-result"
  },
  {
    command: [node, "scripts/check-phase-1-final-operator-value-stopline.mjs"],
    expectStatus: "ok",
    name: "phase-1-final-operator-value-stopline"
  },
  {
    command: [node, "scripts/check-phase-1-final-operator-boolean-reply-intake.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-final-operator-boolean-reviewed-result.mjs"],
    expectStatus: "ok",
    name: "phase-1-final-operator-boolean-reviewed-result"
  },
  {
    command: [node, "scripts/check-phase-1-write-gate-preflight-after-operator-booleans.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-gate-preflight-after-operator-booleans"
  },
  {
    command: [node, "scripts/check-phase-1-write-gate-preflight-requirements-closure.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-gate-preflight-requirements-closure"
  },
  {
    command: [node, "scripts/check-phase-1-write-gate-dry-run-after-preflight-requirements.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-gate-dry-run-after-preflight-requirements"
  },
  {
    command: [node, "scripts/check-phase-1-write-gate-execution-packet-draft-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-gate-execution-packet-draft-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-write-gate-fail-closed-runner-stub.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-gate-fail-closed-runner-stub"
  },
  {
    command: [node, "scripts/check-phase-1-write-gate-runner-stub-post-run-review-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-write-runner-implementation-scope-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-implementation-scope-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-write-runner-server-only-scaffold-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-write-runner-sanitized-candidate-artifact-path-shape-checker-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-sanitized-candidate-artifact-path-shape-checker-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-etf-sanitized-candidate-artifact-path-request-no-fetch.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-write-runner-bounded-insert-missing-only-contract-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-bounded-insert-missing-only-contract-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-write-runner-aggregate-readback-contract-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-aggregate-readback-contract-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-write-runner-rollback-or-quarantine-contract-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-rollback-or-quarantine-contract-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-write-runner-post-write-review-contract-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-post-write-review-contract-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-write-runner-candidate-artifact-set-acceptance-gate.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-candidate-artifact-set-acceptance-gate"
  },
  {
    command: [node, "scripts/check-phase-1-write-runner-implementation-candidate.mjs"],
    expectStatus: "ok",
    name: "phase-1-write-runner-implementation-candidate"
  },
  {
    command: [node, "scripts/check-phase-1-sanitized-row-payload-candidate-artifact-spec.mjs"],
    expectStatus: "ok",
    name: "phase-1-sanitized-row-payload-candidate-artifact-spec"
  },
  {
    command: [node, "scripts/report-phase-1-row-payload-candidate-request-packet.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-etf-sanitized-candidate-artifact-reply-intake-validator-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-etf-sanitized-candidate-artifact-reply-intake-validator-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-etf-sanitized-candidate-artifact-reply-execution-brief-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-etf-sanitized-candidate-artifact-reply-execution-brief-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-etf-reply-pm-acceptance-apply-gate-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-etf-reply-pm-acceptance-apply-gate-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-a1-etf-sanitized-reply-task-packet-no-row-payloads.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-twii-write-attempt-stopline-rollup.mjs"],
    expectStatus: "ok",
    name: "phase-1-twii-write-attempt-stopline-rollup"
  },
  {
    command: [node, "scripts/check-phase-1-twii-operator-value-blocker-rollup.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-twii-field-contract-asset-mapping-alignment-gate.mjs"],
    expectStatus: "ok",
    name: "twii-field-contract-asset-mapping-alignment-gate"
  },
  {
    command: [node, "scripts/check-twii-sanitized-candidate-artifact-pm-intake-gate.mjs"],
    expectStatus: "ok",
    name: "twii-sanitized-candidate-artifact-pm-intake-gate"
  },
  {
  ...
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-operator-decision-gate.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-operator-decision-gate"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-future-bounded-packet-readiness.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-missing-packet-fields.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-missing-packet-fields"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-field-intake-template.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-operator-review-summary.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-operator-review-summary"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-separate-bounded-attempt-review-packet.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-separate-bounded-attempt-review-packet"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-operator-authorization-request-packet.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-operator-authorization-request-packet"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-operator-authorization-response-template.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-operator-authorization-response-template"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-operator-authorization-response-intake-validator.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-operator-authorization-response-intake-validator"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-final-operator-input-surface.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-final-operator-input-surface"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-narrowed-bounded-packet-readiness-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-current-scope-sanitized-candidate-reply-intake-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-sanitized-candidate-reply-intake-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-sanitized-candidate-reply-fixtures-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-sanitized-candidate-reply-fixtures-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-sanitized-candidate-reply-intake-runner-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-sanitized-candidate-reply-intake-runner-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-sanitized-row-payload-candidate-artifact-validator.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-sanitized-row-payload-candidate-artifact-validator"
  },
  {
    command: [node, "scripts/check-current-scope-candidate-converter.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-insert-missing-runner.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-current-scope-candidate-reply-apply-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-candidate-reply-apply-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-candidate-artifact-path-shape-gate-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-candidate-artifact-path-shape-gate-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-candidate-artifact-header-gate-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-candidate-artifact-header-gate-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-candidate-artifact-aggregate-gate-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-candidate-artifact-aggregate-gate-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-candidate-artifact-aggregate-pm-acceptance-record-no-row-payloads.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-candidate-artifact-aggregate-pm-acceptance-record-no-row-payloads"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-candidate-artifact-bounded-write-authorization-preflight-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-candidate-artifact-bounded-write-authorization-preflight-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-explicit-operator-bounded-write-authorization-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-explicit-operator-bounded-write-authorization-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-explicit-operator-bounded-write-authorization-response-intake-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-explicit-operator-bounded-write-authorization-response-intake-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-execution-decision-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-bounded-write-execution-decision-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-execution-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-bounded-write-execution-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-runner-authorization-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-bounded-write-runner-authorization-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-write-capable-runner-scaffold-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-write-capable-runner-scaffold-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-write-runner-execution-authorization-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-write-runner-execution-authorization-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-write-runner-dry-run-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-write-runner-dry-run-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-dry-run-execution-authorization-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-dry-run-execution-authorization-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-dry-run-review-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-dry-run-review-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-dry-run-review-acceptance-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-dry-run-review-acceptance-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-execution-readiness-review-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-bounded-write-execution-readiness-review-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-execution-authorization-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-bounded-write-execution-authorization-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-execution-authorization-response-intake-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-bounded-write-execution-authorization-response-intake-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-pre-execution-review-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-bounded-write-pre-execution-review-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-bounded-write-final-execution-packet-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-current-scope-single-bounded-write-attempt-execution-gate-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-single-bounded-write-attempt-execution-gate-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-authorization-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-authorization-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-authorization-response-intake-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-authorization-response-intake-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-final-go-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-final-go-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-final-go-response-intake-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-final-go-response-intake-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-execution-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-execution-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-execution-authorization-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-execution-authorization-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-execution-authorization-response-intake-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-execution-authorization-response-intake-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-final-execution-readiness-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-final-execution-readiness-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-final-execution-go-no-go-intake-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-final-execution-go-no-go-intake-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-execution-handoff-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-execution-handoff-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-runtime-execution-command-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-runtime-execution-command-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-runtime-execution-authorization-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-runtime-execution-authorization-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-final-operator-execution-acceptance-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-final-operator-execution-acceptance-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-attempt-actual-execution-final-go-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-attempt-actual-execution-final-go-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-external-execution-runbook-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-external-execution-runbook-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-actual-bounded-write-post-run-review-intake-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-actual-bounded-write-post-run-review-intake-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-final-go-readiness-summary-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-current-scope-final-go-readiness-summary-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-current-scope-final-go-reality-reconciliation-2026-06-17.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-public-beta-mock-launch-final-go-2026-06-17.mjs"],
    expectStatus: "ok",
    name: "phase-1-public-beta-mock-launch-final-go-2026-06-17"
  },
  {
  ...
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-dry-run-only-preparation-packet.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-separate-bounded-write-readback-rollback-preparation.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-separate-bounded-write-readback-rollback-preparation"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-bounded-attempt-pre-execution-packet-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-bounded-write-authorization-response-intake-validator.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-bounded-write-authorization-response-intake-validator"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-bounded-write-authorization-response-branch-fixtures.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-bounded-write-authorization-response-branch-fixtures"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-one-bounded-write-attempt-runner-preparation-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-one-bounded-write-attempt-runner-preparation-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-one-attempt-execution-review-packet-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-one-attempt-execution-review-packet-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-operator-go-no-go-record-no-execution.mjs"],
    expectStatus: "ok",
    name: "phase-1-runtime-promotion-operator-go-no-go-record-no-execution"
  },
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-real-accepted-authorization-external-intake-record-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-runtime-promotion-fresh-pm-go-no-go-after-input-convergence-no-execution.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-phase-1-daily-prices-bounded-write-post-run-review-2026-06-16.mjs"],
    expectStatus: "ok",
    name: "phase-1-daily-prices-bounded-write-post-run-review-2026-06-16"
  },
  {
  ...
  {
    command: [node, "scripts/check-phase-1-etf-parallel-coverage-repair-selector.mjs"],
    expectStatus: "ok",
    name: "phase-1-etf-parallel-coverage-repair-selector"
  },
  {
  ...
  {
    command: [node, "scripts/check-twse-openapi-stage-5-supabase-readonly-gate.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-twse-openapi-stage-7-real-score-formula-gate.mjs"],
    expectStatus: "ok",
    name: "twse-openapi-stage-7-real-score-formula-gate"
  },
  {
    command: [node, "scripts/check-twse-openapi-stage-8-score-source-real-promotion-gate.mjs"],
    expectStatus: "ok",
    name: "twse-openapi-stage-8-score-source-real-promotion-gate"
  },
  {
  ...
  {
    command: [node, "scripts/check-twii-report-only-dry-run-chain-gate.mjs"],
    expectStatus: "ok",
    name: "twii-report-only-dry-run-chain-gate"
  },
  {
    command: [node, "scripts/check-twii-bounded-execution-packet-readiness-gate.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-twii-external-to-server-preexecution-chain-convergence-gate.mjs"],
    expectStatus: "ok",
  ...
  {
    command: [node, "scripts/check-twii-operator-decision-intake-chain-convergence-gate.mjs"],
    expectStatus: "ok",
    name: "twii-operator-decision-intake-chain-convergence-gate"
  },
  {
    command: [node, "scripts/check-twii-preexecution-to-authorization-chain-convergence-gate.mjs"],
    expectStatus: "ok",
    name: "twii-preexecution-to-authorization-chain-convergence-gate"
  },
  {
    command: [node, "scripts/check-twii-execution-packet-to-final-stopline-chain-convergence-gate.mjs"],
    expectStatus: "ok",
    name: "twii-execution-packet-to-final-stopline-chain-convergence-gate"
  },
  {
    command: [node, "scripts/check-twii-final-stopline-to-operator-intake-chain-convergence-gate.mjs"],
    expectStatus: "ok",
...
const publicBetaFocusedReviewGateNames = new Set([
  ...
  "phase-1-write-runner-bounded-insert-missing-only-contract-no-execution",
  "phase-1-write-runner-aggregate-readback-contract-no-execution",
...
const phase1LiveCoreReviewGateNames = new Set([
  ...
  "phase-1-runtime-promotion-operator-packet-intake",
  ...
  "phase-1-current-scope-sanitized-candidate-reply-intake-no-row-payloads",
  "phase-1-current-scope-sanitized-candidate-reply-fixtures-no-row-payloads",
  ...
  "phase-1-current-scope-candidate-artifact-header-gate-no-row-payloads",
  "phase-1-current-scope-candidate-artifact-aggregate-gate-no-row-payloads",
  "phase-1-current-scope-candidate-artifact-aggregate-pm-acceptance-record-no-row-payloads",
  "phase-1-current-scope-candidate-artifact-bounded-write-authorization-preflight-no-execution",
  "phase-1-current-scope-explicit-operator-bounded-write-authorization-packet-no-execution",
  "phase-1-current-scope-explicit-operator-bounded-write-authorization-response-intake-no-execution",
  "phase-1-current-scope-bounded-write-execution-decision-gate-no-execution",
  "phase-1-current-scope-bounded-write-execution-packet-no-execution",
  "phase-1-current-scope-bounded-write-runner-authorization-gate-no-execution",
  ...
  "phase-1-public-beta-mock-launch-final-go-2026-06-17",
  ...
  "phase-1-runtime-promotion-one-bounded-write-attempt-runner-preparation-no-execution",
  ...
  "phase-1-daily-prices-bounded-write-post-run-review-2026-06-16",
  "beta-runtime-fast-health",
  "typescript"
]);
