...
const reportPath = "docs/reviews/CP3_TWSE_STOCK_DAY_STAGING_CANONICAL_NAMING_RULE_DECISION_LEDGER_2026-05-30.md";
...
const requiredPhrases = [
  ...
  "local-only decision tracking and local implementation guidance",
...
const forbiddenPhrases = [
  ...
  "twse_stock_day_staging is approved as runtime dependency",
  "twse_stock_day_staging is canonical alias",
  "twse_stock_day_staging is local view",
  "twse_stock_day_staging is local table"
];
