...
const requiredTopPhrases = [
  ...
  "scripts/check-a1-twii-etf-source-rights-evidence-intake-packet.mjs",
  ...
  "No SQL, Supabase write, `daily_prices` mutation, market-data fetch, public promotion, row coverage point, or real score source occurred",
  "Latest TW equity daily_prices existing target overlap policy slice",
  "docs/TW_EQUITY_DAILY_PRICES_EXISTING_TARGET_OVERLAP_POLICY.md",
  "docs/reviews/TW_EQUITY_STAGING_TO_DAILY_PRICES_REMOTE_PREFLIGHT_POST_RUN_REVIEW_2026-06-07.md",
  "scripts/check-tw-equity-daily-prices-existing-target-overlap-policy.mjs",
  "tw_equity_daily_prices_existing_target_overlap_policy_ready_not_executed",
  "existing `daily_prices` target overlap observed `3` rows against expected `0`",
  "production merge remains blocked until overlap classification defines skip/upsert/conflict handling",
  ...
  "no overwrite/upsert/delete",
  "immediate post-write aggregate readback",
  ...
  "mock success inserts `177`, skips `3`, and reads back `180`",
  "mock conflict blocks before mutation",
  ...
  "authorize exactly one bounded real production `daily_prices` merge attempt",
  "candidate rows `180`, insert rows `177`, skipped exact existing rows `3`, conflicts `0`, and final target rows `180`",
  "blocks SQL, dashboard edits, update/upsert/delete, row payload output, stock id output, secrets, repeated execution, row coverage points, public source promotion, and real score source promotion",
  ...
  "staging_twse_stock_day_runs` count is `0",
  "staging_twse_stock_day_prices` count is `0",
  ...
  "No remote Supabase connection, SQL, migration execution, write attempt, staging row, `daily_prices` mutation, market-data fetch, public promotion, row coverage point, or real score source occurred",
  "Latest TW equity Supabase metadata diagnostic runner slice",
  "scripts/report-tw-equity-supabase-metadata-diagnostic-once.mjs",
  "scripts/check-tw-equity-supabase-metadata-diagnostic-once.mjs",
  "bounded metadata diagnostic runner for one bounded read-only metadata diagnostic",
  "TW_EQUITY_SUPABASE_METADATA_DIAGNOSTIC_CONFIRMATION=CEO_APPROVED_TW_EQUITY_SUPABASE_METADATA_DIAGNOSTIC_ONCE",
  "records only sanitized aggregate evidence to the post-run review",
  "Latest TW equity Supabase metadata diagnostic post-run review slice",
  "docs/reviews/TW_EQUITY_SUPABASE_METADATA_DIAGNOSTIC_POST_RUN_REVIEW_2026-06-06.md",
  "scripts/check-tw-equity-supabase-metadata-diagnostic-post-run-review-2026-06-06.mjs",
  ...
  "bounded PostgREST write-path schema exposure or dashboard/API schema comparison before any third write attempt",
  "Latest TW equity PostgREST schema exposure probe slice",
  "scripts/report-tw-equity-postgrest-schema-exposure-probe-once.mjs",
  "docs/reviews/TW_EQUITY_POSTGREST_SCHEMA_EXPOSURE_PROBE_POST_RUN_REVIEW_2026-06-06.md",
  "scripts/check-tw-equity-postgrest-schema-exposure-probe-post-run-review-2026-06-06.mjs",
  ...
  "non-data-changing dashboard/manual schema exposure or cache repair runbook plus outcome record before any third bounded write decision",
  ...
  "Latest TW equity PostgREST schema exposure probe runner gate slice",
  "tw_equity_postgrest_schema_exposure_probe_blocked_repair_outcome_accepted_required",
  "must not connect or write a post-run review until `data/source-gates/tw-equity-schema-exposure-repair-outcomes.json` records an accepted outcome",
