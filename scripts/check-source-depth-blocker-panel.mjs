...
const required = [
  ...
  [helperPath, "Freshness metadata 已可讀但仍待來源深度覆核"],
  [helperPath, "Supabase freshness read-only metadata run"],
  [helperPath, "TWSE / 2026-05-27 / TWSE OpenAPI / complete"],
  [helperPath, "只能作 runtime 狀態揭露"],
  [helperPath, "不能作真實市場資料、資料品質或 scoreSource=real 依據"],
  [helperPath, "freshness metadata evidence"],
