...
const reportPath = "docs/reviews/CP3_SOURCE_DEPTH_EVIDENCE_TEMPLATE_USAGE_GUIDE_ROLE_REVIEW_2026-05-29.md";
...
const requiredPhrases = [
  ...
  "forbids Supabase reads, SQL execution, raw market rows, CSV market data, JSON market",
  "local-only CP3 source-depth evidence artifact approval gate plan",
