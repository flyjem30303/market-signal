...
const requiredPhrases = [
  "Status: CP3 source-depth local-only chairman review handoff packet rejection transition route dependency decision request narrow question candidate post-review Option A continuation worklist role review recorded",
  "REVISE",
  "Option A continuation worklist role review only",
  "accepted as reviewed local-only sequencing guidance",
  ...
  "docs/reviews/CP3_SOURCE_DEPTH_LOCAL_ONLY_CHAIRMAN_REVIEW_HANDOFF_PACKET_REJECTION_TRANSITION_ROUTE_DEPENDENCY_DECISION_REQUEST_NARROW_QUESTION_CANDIDATE_POST_REVIEW_OPTION_A_CONTINUATION_WORKLIST_2026-05-30.md reviewed",
  "scripts/check-cp3-source-depth-local-only-chairman-review-handoff-packet-rejection-transition-route-dependency-decision-request-narrow-question-candidate-post-review-option-a-continuation-worklist.mjs reviewed",
  "scripts/check-cp3-tw-stock-source-depth.mjs remains not_ready as expected",
  "Work Item A1 refine local-only decision context remains local-only",
  "Work Item A2 refine unresolved decision ledger remains local-only",
  "Work Item A3 refine role concern boundaries remains local-only",
  "Work Item A4 refine B C candidate separation remains local-only",
  "Work Item A5 refine blocked D E F dependency labels remains local-only",
  "Work Item A6 refine stop-condition wording remains local-only",
  "Work Item A7 refine review gate coverage remains local-only",
  "Work Item A8 prepare next Option A checkpoint summary remains local-only",
  "CEO accepts the worklist as reviewed local-only sequencing guidance",
  ...
  "CEO confirms Work Item A1 through Work Item A8 do not escalate to the user",
  "CEO confirms Option D remains blocked",
  "CEO confirms Option E remains blocked",
  "CEO confirms Option F remains blocked",
  "PM accepts the worklist as sequencing guidance only",
  "PM confirms the worklist does not create delivery commitment",
  ...
  "PM confirms A1 through A8 are safe local-only candidates",
  "Engineering confirms the worklist role review creates no runtime code change",
  ...
  "Legal confirms the worklist role review cannot approve source rights",
  ...
  "Investment confirms the worklist role review cannot clear source-depth not_ready",
  ...
  "Marketing confirms the worklist role review cannot release public claims",
  ...
  "QA accepts the checker coverage for Option A continuation worklist role review",
  "QA confirms stop conditions prevent worklist-review-to-question-candidate drift",
  "QA confirms stop conditions prevent worklist-review-to-user-question drift",
  "QA confirms stop conditions prevent worklist-review-to-approval drift",
  "QA confirms stop conditions prevent worklist-review-to-execution drift",
  "QA confirms stop conditions prevent worklist-review-to-handoff drift",
  "QA confirms stop conditions prevent worklist-review-to-meeting drift",
  "QA confirms stop conditions prevent worklist-review-to-authorization drift",
  "QA confirms stop conditions prevent worklist-review-to-Supabase drift",
  "QA confirms stop conditions prevent worklist-review-to-SQL drift",
  "QA confirms stop conditions prevent worklist-review-to-market-data drift",
  "QA confirms stop conditions prevent worklist-review-to-runtime drift",
  "QA confirms stop conditions prevent worklist-review-to-public-claim drift",
  "The Option A continuation worklist is accepted as reviewed local-only sequencing guidance.",
  "Work Item A1 through Work Item A8 remain local-only candidates.",
  "Work Item A1 through Work Item A8 do not authorize execution.",
  "Work Item A1 through Work Item A8 do not create external dependencies.",
  ...
  "chairman review handoff packet rejection transition route dependency decision request narrow question candidate post-review Option A continuation worklist role review only",
  ...
  "record CP3 source-depth local-only chairman review handoff packet rejection transition route dependency decision request narrow question candidate post-review Option A local-only decision context refinement"
];
