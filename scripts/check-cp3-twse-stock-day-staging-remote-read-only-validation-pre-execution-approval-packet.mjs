...
const reportPath = "docs/reviews/CP3_TWSE_STOCK_DAY_STAGING_REMOTE_READ_ONLY_VALIDATION_PRE_EXECUTION_APPROVAL_PACKET_2026-05-29.md";

const requiredPhrases = [
  "Status: remote read-only validation pre-execution approval packet recorded",
  "REVISE",
  "does not approve running the validator",
  "does not approve connecting to Supabase",
