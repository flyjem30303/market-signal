...
const target = "docs/reviews/CP3_SUPABASE_SCHEMA_SHAPE_REMOTE_EXECUTION_PACKET_DRAFT_2026-05-30.md";
const content = readFileSync(target, "utf8");

const requiredPhrases = [
  "CP3 Supabase Schema-Shape Remote Execution Packet Draft",
  "CP3 Supabase schema-shape remote execution packet draft recorded",
  "DRAFT_FOR_REVIEW_ONLY_NOT_EXECUTION_APPROVAL",
  ...
  "reviewable schema-shape execution decision",
  "does not authorize a run",
  "role review of this packet draft",
  "one-attempt rule",
  "sanitized output categories",
  "stop conditions",
