...
const outcomeDataPath = path.join(process.cwd(), "data/source-gates/runner-approval-decision-outcomes.json");
const allowedIds = new Set(["report-only-runner-implementation-slice"]);
...
const result = {
  mode: "local_runner_approval_decision_outcome_recording",
