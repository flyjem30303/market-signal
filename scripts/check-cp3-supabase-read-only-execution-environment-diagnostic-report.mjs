...
const reportPath = "docs/reviews/CP3_SUPABASE_READ_ONLY_EXECUTION_ENVIRONMENT_DIAGNOSTIC_REPORT_2026-05-30.md";
...
const requiredPhrases = [
  ...
  "without another Supabase\nremote validation attempt",
  "did not reproduce `Access is denied`\nwithout the confirmation-enabled remote path",
  "No Supabase readiness evidence is\naccepted from this report",
  ...
  "local tooling and env loading are\nhealthy",
  "confirmation-enabled remote path remains blocked",
