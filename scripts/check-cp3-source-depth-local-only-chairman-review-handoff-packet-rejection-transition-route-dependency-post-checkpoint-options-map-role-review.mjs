...
const requiredPhrases = [
  "Status: CP3 source-depth local-only chairman review handoff packet rejection transition route dependency post-checkpoint options map role review recorded",
  "REVISE",
  "route dependency post-checkpoint options map role review only",
  ...
  "CEO confirms Option B is only a user-reviewed choice",
  "CEO confirms Option B requires explicit user approval before drafting",
  "CEO confirms Option C is only a user-executed timing decision",
  ...
  "CEO must not execute Option B or Option C autonomously",
  "PM accepts the options map as sequencing context",
  "PM confirms Option A may continue as local-only work",
  "PM confirms Option B is not started",
  "PM confirms Option C is not executed",
  ...
  "QA accepts the checker coverage for post-checkpoint options map role review",
  ...
  "The post-checkpoint options map is accepted as reviewed local-only route sequencing.",
  ...
  "chairman review handoff packet rejection transition route dependency post-checkpoint options map role review only",
  ...
  "record CP3 source-depth local-only chairman review handoff packet rejection transition route dependency decision request readiness gate"
];
