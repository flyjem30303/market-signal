...
const required = [
  ...
  [gatePath, "approvalState: \"approved\""],
  [gatePath, "approvedBy: \"Chairman\""],
  [gatePath, "approvedAt: \"2026-06-01T14:22:00+08:00\""],
  ...
  [gatePath, "approves exactly one future report-only runner attempt"],
