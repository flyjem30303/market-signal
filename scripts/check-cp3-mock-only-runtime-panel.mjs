...
const requiredComponentPhrases = [
  ...
  "資料判讀與授權細節",
  "角色、handoff、external gate 提案細節",
  "後續 gate 與工作隊列細節",
  "commandCenter.summary",
  "commandCenter.doNow",
  "commandCenter.doNext",
  "commandCenter.doNotDo",
  "commandCenter.evidenceLevel",
  "commandCenter.executionState",
  "commandCenter.executionLanes.map",
  "commandCenter.externalReadinessChecks.map",
  "commandCenter.gateProposalProgress.label",
  "commandCenter.gateProposalProgress.nextDraftLabel",
  "commandCenter.gateProposalProgress.blockedExecutionLabel",
  "commandCenter.gateProposalQueue.map",
  "commandCenter.gateProposalQueueLabel",
  "commandCenter.handoffChecks.map",
  "commandCenter.milestones.map",
  "commandCenter.operatingMode",
  "commandCenter.priorityLabel",
  "commandCenter.reviewCadence",
  "commandCenter.riskLabel",
  "commandCenter.roleActions.map",
...
const requiredRuntimePhrases = [
  ...
  "Priority: improve local runtime decision clarity before opening any external-data gate.",
  "Main risk: mistaking metadata, schema shape, or UI readiness for production data readiness.",
  "Mock-only runtime state remains explicit.",
  "Static guard covers command center fields.",
  "No external-data gate is opened by this UI.",
  "Review cadence and stop condition are visible.",
  "Local runtime shell committed",
  "Decision clarity pass",
  "External-data transition",
  "Panel, command center, handoff checks, and static guard are in the local app.",
  "CEO and PM keep improving local readability before any external-data gate.",
  "Supabase, SQL, market rows, formal score, and public claims remain blocked.",
  "Local Runtime UI",
  "Guard Hardening",
  "Source Evidence Prep",
  "Formal Score Review",
  "Rights Review",
  "External Gate",
  "Local UI and static guards only.",
  "Local checks only; no remote service dependency.",
  "Question and evidence planning only; no market rows.",
  "Decision criteria only; no formal score transition.",
  "Review questions only; no data usage expansion.",
  "Separate gate required before external-data work.",
  "External readiness checks",
  "Supabase read-only command gate",
  "Schema-shape confirmation",
  "Market data evidence",
  "Source rights boundary",
  "Formal score transition",
  "A separate CEO gate must authorize the exact read-only remote command before any Supabase access.",
  "Engineering must confirm schema-shape assumptions without writing tables or creating database seed scripts.",
  "Data must document source depth, freshness limits, and downgrade rules before market-row ingestion.",
  "Legal must confirm public display and redistribution boundaries before source expansion.",
  "Investment must approve model and backtest evidence before any formal score-source transition.",
  "Gate proposal queue",
  "Supabase read-only evidence run",
  "Schema contract comparison",
  "Source-depth evidence packet",
  "Source-rights review packet",
  "Formal score transition packet",
  "External execution decision",
  "One exact read-only command, one run, no writes, no data mutation.",
  "Compare contract shape only; do not infer data quality or public claim fitness.",
  "Evidence criteria only; no market-row ingestion or persisted market dataset.",
  "Rights questions only; no data usage expansion or public redistribution claim.",
  "Model criteria only; do not change score source or public wording.",
  "CEO decision only after the earlier proposal items have evidence.",
  "Gate proposals ${draftCount} draft / ${gateProposalQueue.length} total",
  ...
  "draft",
  "recorded",
  "Refine local runtime readability and keep public copy mock-only.",
  "Harden static guards and keep runtime free of external data dependencies.",
  "Prepare source-depth evidence without market rows or remote validation.",
  "Prepare source-rights questions before any data usage expansion.",
  "Prepare formal-score review criteria without switching score source.",
  "Decide when to open a separate gate for external-data work.",
  "acceptance: string",
...
const requiredCssPhrases = [
  ...
  ".cp3-runtime-command-center aside",
  ".cp3-runtime-command-center div",
  ".cp3-runtime-command-center ul",
  ".cp3-runtime-command-center ol",
  ".cp3-runtime-command-center article",
  ".cp3-runtime-command-center nav",
  ".cp3-runtime-command-center footer",
  ".cp3-runtime-command-center menu",
  ".cp3-runtime-command-center menu mark",
  ".cp3-runtime-route-decision",
  ".cp3-runtime-route-work-queue",
