...
const requiredPhrases = [
  "Status: CP3 source-depth local-only authorization transition human-decision meeting question backlog role review recorded",
  "REVISE",
  "local-only authorization transition human-decision meeting question backlog role review",
  "human-decision meeting question backlog accepted as local-only governance preparation",
  ...
  "scripts/check-cp3-source-depth-local-only-authorization-transition-human-decision-meeting-question-backlog.mjs reviewed",
  ...
  "PM accepts the question backlog as unanswered meeting-preparation material",
  ...
  "Marketing accepts unanswered questions cannot become public messaging",
  ...
  "no public meeting question wording is approved",
  "Investment accepts unanswered questions do not improve model credibility state",
  ...
  "Legal accepts the question backlog as local-only governance preparation",
  ...
  "CEO accepts the human-decision meeting question backlog role review as local-only review",
  ...
  "next safe slice is a local-only authorization transition human-decision meeting readiness summary",
  ...
  "no meeting-question UI is approved",
  "QA accepts the human-decision meeting question backlog role review as gateable local-only evidence",
  "review gates include the authorization transition human-decision meeting question backlog",
  ...
  "CEO resolves conflicts by selecting a human-decision meeting readiness summary as the next local-only slice",
  "reviewed local-only human-decision meeting question backlog",
  "questions remain unanswered",
  "meeting readiness is not execution readiness",
  "next safe slice should record a human-decision meeting readiness summary",
  ...
  "authorization transition human-decision meeting question backlog role review only",
  ...
  "record CP3 source-depth local-only authorization transition human-decision meeting readiness summary",
];
