...
for (const [file, phrase] of [
  ...
  [helperPath, "readyForNextReadonlyDecision"],
  ...
  [helperPath, "confirm the existing Legal local outcome"],
  ...
  [componentPath, "summary.nextExecutablePacket.readyForNextReadonlyDecision"],
