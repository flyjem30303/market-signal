...
for (const [file, phrase] of [
  ...
  [helperPath, "postReviewReportCommand"],
  [helperPath, "postReviewCheckCommand"],
  [helperPath, "local_output_ready_for_ceo_oral_review"],
  [helperPath, "npm run report:provider-specific-terms-post-review-rollup"],
  [helperPath, "npm run check:provider-specific-terms-post-review-rollup"],
  [helperPath, "CEO oral accepted/rejected handling"],
  ...
  [componentPath, "summary.nextExecutablePacket.postReviewStatus"],
  [componentPath, "summary.nextExecutablePacket.postReviewReportCommand"],
  [componentPath, "summary.nextExecutablePacket.postReviewCheckCommand"],
