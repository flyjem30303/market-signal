...
const required = [
  ...
  [helperPath, "DataReadinessIntegrationQueueItem"],
  ...
  [helperPath, "integrationQueue: DataReadinessIntegrationQueueItem[]"],
  [helperPath, "mainline-runtime-bridge"],
  [helperPath, "a1-readonly-evidence"],
  [helperPath, "a2-public-copy-readiness"],
  [helperPath, "accepted_for_mainline_review"],
  [helperPath, "monitor_only"],
  [helperPath, "A1 evidence can be used as sanitized aggregate readiness context"],
  [helperPath, "A2 public-copy checks report no boundary-insufficient files"],
  ...
  [componentPath, "dataReadiness.integrationQueue.map"],
  [componentPath, "project-progress-data-readiness-integration"],
  ...
  [cssPath, ".project-progress-data-readiness-integration"],
