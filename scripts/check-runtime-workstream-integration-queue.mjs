...
const required = [
  ...
  [libPath, "A1 blocker-closure packet separates data-quality evidence"],
  [libPath, "row-coverage readiness"],
  [libPath, "field-validity QA"],
  [libPath, "downgrade rules"],
  [libPath, "without running SQL, remote reads, remote writes, row payloads, or raw market-data ingestion"],
  [libPath, "A2 public-copy review confirms blocker-closure wording is understandable"],
  [libPath, "mock-only state, source-rights limits, model-credibility limits, and real-score stop lines"],
  [libPath, "without editing A1 data evidence or runtime source promotion logic"],
