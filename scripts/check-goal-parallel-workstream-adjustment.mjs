...
const requiredDocPhrases = [
  ...
  "public Beta plus the first usable data-realification closed loop",
  "請把專案推到「可公開 Beta 上線，並完成資料真實化主路徑的第一個可用閉環」",
  "PM 是主線與唯一整合 owner",
  ...
  "網站可公開 Beta 使用",
  "TW equity 真實 daily_prices 閉環",
  "TWII 與 ETF 缺口",
  "runtime promotion gate",
  "ingestion/backfill/write/readback/post-run review/rollback/retention",
  "publicDataSource 與 scoreSource",
