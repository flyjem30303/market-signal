...
const reportPath = "docs/reviews/CP3_SUPABASE_READ_ONLY_GUARDED_VALIDATOR_IMPLEMENTATION_REVIEW_2026-05-30.md";
...
const requiredPhrases = [
  ...
  "guarded remote-capable validator",
  ...
  "The guarded validator implementation is accepted.",
  "prepare a one-run execution gate draft",
  "actual command may run only after CEO\nrecords the exact confirmation scope",
