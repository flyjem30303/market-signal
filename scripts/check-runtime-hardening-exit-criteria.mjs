...
const required = [
  ...
  [libPath, "RuntimeHardeningPublicBoundaryItem"],
  [libPath, "Public boundary summary"],
  [libPath, "What users can see now"],
  [libPath, "What is not live yet"],
  [libPath, "What local checks support"],
  [libPath, "Supabase-backed public data, SQL-backed scoring, and real market-data claims remain blocked."],
  ...
  [componentPath, "runtime-public-boundary-summary"],
  [componentPath, "runtimeHardeningExit.publicBoundaryItems"],
  [componentPath, "runtimeHardeningExit.publicBoundaryLabel"],
