...
const reportPath = "docs/reviews/CP3_TWSE_STOCK_DAY_STAGING_REMOTE_READ_ONLY_VALIDATION_READINESS_CHECKLIST_2026-05-29.md";

const requiredPhrases = [
  "Status: remote read-only validation readiness checklist recorded",
  "REVISE",
  "Remote read-only validation is still not approved",
  "checklist only",
