...
for (const phrase of [
  ...
  "`OFFICIAL-001`",
  "ACCEPTED_SAFE_PUBLIC_REFERENCE",
  "TWSE`) is the official public authority/source surface for TAIEX/TWII index series",
  "`OFFICIAL-002`",
  "TERMS_LOCATION_IDENTIFIED_SAFE_PUBLIC_REFERENCE",
  "`OFFICIAL-003`",
  "BLOCKED_PENDING_TWSE_CONSENT_OR_CONTRACTED_METHOD",
  "`OFFICIAL-012`",
