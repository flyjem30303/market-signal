...
const t = {
  breadth: "\u5e02\u5834\u5ee3\u5ea6",
  checkData: "\u8cc7\u6599\u72c0\u614b\u9700\u8981\u5148\u78ba\u8a8d\uff0c\u5148\u628a mock \u8a0a\u865f\u7576\u89c0\u5bdf\u7dda\u7d22",
  ...
  stopLine:
    "\u516c\u958b Beta \u4ecd\u70ba\u95b1\u8b80\u8207\u89c0\u5bdf\u7528\u9014\uff1apublicDataSource=mock\uff1bscoreSource=mock\uff1b\u4e0d\u63d0\u4f9b\u8cb7\u8ce3\u5efa\u8b70\u6216\u5831\u916c\u627f\u8afe\u3002",
  watchMarket: "\u5148\u770b\u5927\u76e4\u8108\u7d61"
};
...
export function buildHomeMarketActionSummary(
  ...
  if (hasDataWarnings) {
    return {
      ...
      marketBreadthLine: `${breadthLine} \u76ee\u524d\u9801\u9762\u4ecd\u4ee5 mock-only runtime \u5448\u73fe\u3002`,
      primaryAction: {
