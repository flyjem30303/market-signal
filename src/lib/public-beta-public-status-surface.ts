...
export function getPublicBetaPublicStatusSurface(): PublicBetaPublicStatusSurface {
  return {
    cards: [
      {
        body: "首頁、簡報、週報、個股頁與法務頁都已收斂成一般投資者可閱讀的公開內容。",
        label: "公開閱讀",
        title: "核心路由可用",
        tone: "active"
      },
      {
        body: "目前仍以示範資料呈現，真實資料來源、授權條件與更新流程確認後才會切換。",
        label: "資料狀態",
        title: "示範資料清楚標示",
        tone: "readying"
      },
      {
        body: "會員功能已先規劃為下一階段，公開版先完成市場總覽、核心指標與風險提示。",
        label: "會員規劃",
        title: "不阻塞公開版",
        tone: "blocked"
      }
    ],
    headline: "公開 Beta 先聚焦可理解的市場總覽",
    stopLine: "所有頁面維持非投資建議、示範資料與更新時間揭露，避免使用者誤判。",
    summary:
