...
export function PublicBetaSourceCoverageBridge({
  ...
  return (
    <section className="panel stock-reading-summary public-beta-source-coverage-bridge" aria-label="資料來源與覆蓋說明">
      <p className="eyebrow">資料來源與覆蓋</p>
      <h2>正式資料上線前，先把資料邊界說清楚</h2>
      <p>
        {contextLabel}
        目前公開頁以示範資料呈現市場閱讀流程。正式資料需要完成合法來源確認、欄位契約、覆蓋範圍與異常回退後，才會切換成正式資料狀態。
      </p>
