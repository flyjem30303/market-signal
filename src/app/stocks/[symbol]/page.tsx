...
const stockPagePublicCopyContract =
  "指數燈號標的頁提供市場狀態、標的基本資料、市場分數、風險分數與資料限制說明；Phase 1 使用示範資料，不提供買賣建議。";
...
export function generateMetadata({ params }: StockPageProps): Metadata {
  ...
  const description = `${asset.symbol} ${asset.name} 的指數燈號、市場分數、風險分數、標的基本資料與資料時間。Phase 1 使用示範資料，不提供買賣建議。`;
