...
- Next safe mainline work: run one final milestone verification pass in sequence, then repair only concrete failures; do not start Supabase, SQL, market-data fetch/ingestion, public source promotion, or `scoreSource=real` without a separately named CEO gate.
