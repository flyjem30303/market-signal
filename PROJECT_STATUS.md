...
- Latest source-rights public copy acceptance slice: `scripts/report-source-rights-public-copy-acceptance-readiness.mjs` and `scripts/check-source-rights-public-copy-acceptance-readiness.mjs` now consolidate source attribution copy, redistribution and retention copy, investment claim copy, and runtime boundary copy acceptance maps. Source-rights disclosure moved from 88% to 92%; external provider terms, source license approval, redistribution, public source promotion, Supabase execution, SQL, ingestion, professional indicator claims, and `scoreSource=real` remain blocked.
- Latest slice record: goal is overall project 100% MVP readiness. This slice raised source-rights disclosure readiness with public copy acceptance evidence, kept project progress at 85%, moved source-rights disclosure to 92%, and registered the new source-rights public copy acceptance gate in package scripts, localhost full health, and review gates. It touched legal/source-rights/gate/documentation only; `publicDataSource=mock` and `scoreSource=mock` remain correct; no remote connection, SQL, write, raw data, or secret output occurred.
