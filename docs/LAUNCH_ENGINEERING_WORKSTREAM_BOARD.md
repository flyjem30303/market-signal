...
- If copy placement is already covered, run route health for `/weekly`, `/methodology`, `/disclaimer`, `/terms`, and `/privacy`, then continue data coverage source-rights unblock if route health is stable.
