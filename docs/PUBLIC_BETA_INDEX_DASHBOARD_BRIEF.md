...
- 首頁顯示市場總覽燈號、核心指標、主要風險提示與資料更新時間。
- 使用者進站後能快速理解目前市場狀態。
- 每個核心燈號具備狀態、原因、更新時間與簡短解釋。
- 公開頁面沒有內部流程、命令、角色代號、硬阻塞、候選檔案或開發殘留。
- 資料來源、更新時間、資料可能延遲與非投資建議提示清楚。
...
2. 移除公開頁中的亂碼、內部欄位名、命令、開發流程、hard blocker、candidate artifact、operator packet 等殘留。
3. 讓首頁、股票頁、briefing、weekly、methodology、disclaimer、terms、privacy 都符合「市場狀態、原因、更新時間、風險提醒、資料邊界、下一步觀察」。
4. A1 繼續資料來源與覆蓋率，不影響公開頁清理。
