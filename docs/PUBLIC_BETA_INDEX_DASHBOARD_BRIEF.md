...
CEO 判斷：Phase 1 先完成所有訪客都能使用的免費「指數燈號網站」。會員登入、會員深度解讀、自選追蹤、自訂警示與盤後複盤屬於 Phase 2，不應拖慢 Phase 1 的公開 Beta 上線。
...
- 提供自選追蹤、自訂警示條件、個人關注指標、收藏紀錄與提醒功能。
...
- 核心頁面可正常載入，RWD 正常，文字對比、字級、標題階層可讀。
- 所有頁面皆有必要的風險聲明、資料來源/更新時間說明與非投資建議提示。
- 若資料異常或尚未真實化，前台要顯示清楚狀態，不讓使用者誤判。
...
- Home、briefing、weekly、stock、methodology、disclaimer、terms、privacy 的使用者可讀性
- 燈號狀態、原因、風險提示、更新時間與下一步觀察
- 公開頁面開發殘留清理
- Beta 上線整合
...
- 自選追蹤 / alert / post-market review 資料與畫面設計
- 轉換事件與商業指標規劃
...
2. 繼續清理公開頁面上所有內部欄位名、開發過程資料、command、packet、blocker、operator、raw payload、local path 等非使用者資訊。
3. 讓 Home、briefing、weekly、stock、methodology、disclaimer、terms、privacy 都能支持「30 秒看懂市場氛圍，3 分鐘形成觀察判斷」。
