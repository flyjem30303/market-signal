...
Supabase object reachability is no longer unknown for the expected objects. The next high-value work should move to bounded schema-shape evidence and runtime wiring that still keeps public data source as mock and keeps `scoreSource=real` blocked.
